...
class ReviewsUI {
	...
	public function render() {
		...
		if ( $this->reviewLogic->shouldShowReviewModal() ) {
			...
			<input type="hidden" id="wpai-modal-type"
			       value="<?php esc_attr_e( $this->reviewLogic->getModalType() ); ?>" />
			<div style="" class="notice notice-info wpai-reviews-notice">
				...
				<div id="wpai-review">
					...
					<div class="wpai-buttons-container">
						<a class="review-link" href="<?php echo esc_attr( $this->reviewLogic->getReviewLink() ); ?>"
						   target="_blank">
				...
				<div id="wpai-feedback">
					...
					<div class="wpai-submit-confirmation">
						Thank you for your feedback. Your message was emailed to support@wpallimport.com
						from <?php echo get_option( 'admin_email' ); ?>. If you do not receive a confirmation email, it
						means we didn't receive your message for some reason.
					</div>
