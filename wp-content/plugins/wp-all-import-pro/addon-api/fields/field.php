...
class PMXI_Addon_Field {
	...
	public function beginHtml() {
		...
		return view( $view, $this->params(), null, false );
	}
	...
	public function getView( $type, $params ) {
		...
		return view( 'fields/' . $type, $params, 'fields/unsupported', null, false );
	}
	...
	protected function locateViewOverride() {
		return view( 'html', $this->params(), null, false, static::$locate_template_in . '/' );
	}
}
