		...
		<div class="pmxi-addon-input-wrap">
			...
			<div class="pmxi-addon-two-columns">
				<div>
					...
					<div class="pmxi-addon-input-wrap">
						<input type="text" name="<?php echo $html_name; ?>[manual_lat]"
						       id="<?php echo $html_id . 'manual_lat'; ?>"
				...
				<div>
					...
					<div class="pmxi-addon-input-wrap">
						<input type="text" name="<?php echo $html_name; ?>[manual_lng]"
						       id="<?php echo $html_id . 'manual_lng'; ?>"
	...
	<div class="pmxi-addon-map-settings">
		<div class="pmxi-addon-map-settings-header">
			...
			<input type="checkbox" class="pmxi-reveal-on-change" data-target="<?php echo $html_id; ?>_maps_settings"
			       name="<?php echo $html_name; ?>[enable_maps_settings]"
			       id="<?php echo $html_id . '_enable_maps_settings'; ?>"
		...
		<div class="pmxi-addon-map-settings-content pmxi-content-to-reveal" id="<?php echo $html_id; ?>_maps_settings"
		     hidden>
			...
			<input type="checkbox" class="pmxi-reveal-on-change" data-target="<?php echo $html_id; ?>_custom_api_key"
			       name="<?php echo $html_name; ?>[use_custom_api_key]"
			       id="<?php echo $html_id . '_use_custom_api_key'; ?>"
