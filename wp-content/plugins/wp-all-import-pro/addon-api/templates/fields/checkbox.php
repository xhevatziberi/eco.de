<ul class="pmxi-addon-checkbox-list">
	<?php foreach ( $field['choices'] as $choice ) : ?>
		...
		<li>
			<label>
				<input data-test="input" type="checkbox"
				       id="checkbox-choice-<?php echo esc_attr( $field['key'] . '-' . $choice['value'] ); ?>"
				       name="<?php echo esc_attr( $html_name ); ?>"
				       value="<?php echo esc_attr( $choice['value'] ); ?>" <?php echo $checked ? 'checked' : ''; ?>>
