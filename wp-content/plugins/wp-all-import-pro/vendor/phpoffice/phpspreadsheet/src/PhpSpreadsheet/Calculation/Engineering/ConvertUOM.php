...
class ConvertUOM {
	...
	private static $conversionUnits = [
		...
		'lbm'       => [
			'Group'       => self::CATEGORY_WEIGHT_AND_MASS,
		...
		'cwt'       => [
			'Group'       => self::CATEGORY_WEIGHT_AND_MASS,
			'Unit Name'   => 'U.S. (short) hundredweight',
			'AllowPrefix' => false,
		],
		'shweight'  => [
			'Group'       => self::CATEGORY_WEIGHT_AND_MASS,
		...
		'uk_cwt'    => [
			'Group'       => self::CATEGORY_WEIGHT_AND_MASS,
			'Unit Name'   => 'Imperial hundredweight',
			'AllowPrefix' => false,
		],
		'lcwt'      => [
			'Group'       => self::CATEGORY_WEIGHT_AND_MASS,
		...
		'survey_mi' => [ 'Group'       => self::CATEGORY_DISTANCE,
		                 'Unit Name'   => 'U.S survey mile (statute mile)',
		                 'AllowPrefix' => false,
		],
		// Time
		...
		// Temperature
		'C'         => [ 'Group'       => self::CATEGORY_TEMPERATURE,
		                 'Unit Name'   => 'Degrees Celsius',
		                 'AllowPrefix' => false,
		],
		'cel'       => [ 'Group'       => self::CATEGORY_TEMPERATURE,
		                 'Unit Name'   => 'Degrees Celsius',
		                 'AllowPrefix' => false,
		],
		'F'         => [ 'Group'       => self::CATEGORY_TEMPERATURE,
		                 'Unit Name'   => 'Degrees Fahrenheit',
		                 'AllowPrefix' => false,
		],
		'fah'       => [ 'Group'       => self::CATEGORY_TEMPERATURE,
		                 'Unit Name'   => 'Degrees Fahrenheit',
		                 'AllowPrefix' => false,
		],
		...
		'Rank'      => [ 'Group'       => self::CATEGORY_TEMPERATURE,
		                 'Unit Name'   => 'Degrees Rankine',
		                 'AllowPrefix' => false,
		],
		'Reau'      => [ 'Group'       => self::CATEGORY_TEMPERATURE,
		                 'Unit Name'   => 'Degrees Réaumur',
		                 'AllowPrefix' => false,
		],
		// Volume
		...
		'uk_qt'     => [ 'Group'       => self::CATEGORY_VOLUME,
		                 'Unit Name'   => 'Imperial Quart (UK)',
		                 'AllowPrefix' => false,
		],
		'gal'       => [ 'Group' => self::CATEGORY_VOLUME, 'Unit Name' => 'Gallon', 'AllowPrefix' => false ],
		'uk_gal'    => [ 'Group'       => self::CATEGORY_VOLUME,
		                 'Unit Name'   => 'Imperial Gallon (UK)',
		                 'AllowPrefix' => false,
		],
		...
		'Nmi3'      => [ 'Group'       => self::CATEGORY_VOLUME,
		                 'Unit Name'   => 'Cubic Nautical Mile',
		                 'AllowPrefix' => false,
		],
		'Nmi^3'     => [ 'Group'       => self::CATEGORY_VOLUME,
		                 'Unit Name'   => 'Cubic Nautical Mile',
		                 'AllowPrefix' => false,
		],
		...
		'GRT'       => [ 'Group'       => self::CATEGORY_VOLUME,
		                 'Unit Name'   => 'Gross Registered Ton',
		                 'AllowPrefix' => false,
		],
		'regton'    => [ 'Group'       => self::CATEGORY_VOLUME,
		                 'Unit Name'   => 'Gross Registered Ton',
		                 'AllowPrefix' => false,
		],
		'MTON'      => [ 'Group'       => self::CATEGORY_VOLUME,
		                 'Unit Name'   => 'Measurement Ton (Freight Ton)',
		                 'AllowPrefix' => false,
		],
		// Area
		...
		'us_acre'   => [ 'Group'       => self::CATEGORY_AREA,
		                 'Unit Name'   => 'US Survey/Statute Acre',
		                 'AllowPrefix' => false,
		],
		...
		'Nmi2'      => [ 'Group'       => self::CATEGORY_AREA,
		                 'Unit Name'   => 'Square Nautical Miles',
		                 'AllowPrefix' => false,
		],
		'Nmi^2'     => [ 'Group'       => self::CATEGORY_AREA,
		                 'Unit Name'   => 'Square Nautical Miles',
		                 'AllowPrefix' => false,
		],
