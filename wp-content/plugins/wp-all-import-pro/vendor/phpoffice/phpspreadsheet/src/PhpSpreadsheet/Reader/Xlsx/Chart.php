		...
		foreach ( $chartElementsC as $chartElementKey => $chartElement ) {
			switch ( $chartElementKey ) {
				case 'spPr':
					...
					break;
				case 'roundedCorners':
					/** @var bool */ $roundedCorners = self::getAttribute( $chartElementsC->roundedCorners, 'val', 'boolean' );
					...
					foreach ( $chartElement as $chartDetailsKey => $chartDetails ) {
						...
						switch ( $chartDetailsKey ) {
							case 'autoTitleDeleted':
								/** @var bool */ $autoTitleDeleted = self::getAttribute( $chartElementsC->chart->autoTitleDeleted, 'val', 'boolean' );
								...
								foreach ( $chartDetails as $chartDetailKey => $chartDetail ) {
									...
									switch ( $chartDetailKey ) {
										...
										case 'pie3DChart':
											...
											break;
										case 'scatterChart':
											/** @var string */ $scatterStyle = self::getAttribute( $chartDetail->scatterStyle, 'val', 'string' );
											$plotSer                         = $this->chartDataSeries( $chartDetail, $chartDetailKey );
										...
										case 'bubbleChart':
											...
											break;
										case 'radarChart':
											/** @var string */ $radarStyle = self::getAttribute( $chartDetail->radarStyle, 'val', 'string' );
											$plotSer                       = $this->chartDataSeries( $chartDetail, $chartDetailKey );
