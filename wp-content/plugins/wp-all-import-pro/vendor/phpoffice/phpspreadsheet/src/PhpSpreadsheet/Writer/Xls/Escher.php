	...
	public function close() {
		...
		switch ( get_class( $this->object ) ) {
			...
			case DggContainer::class:
				...
				// dgg data
				$dggData = pack( 'VVVV', $this->object->/** @scrutinizer ignore-call */ getSpIdMax(), // maximum shape identifier increased by one
					$this->object->/** @scrutinizer ignore-call */ getCDgSaved() + 1, // number of file identifier clusters increased by one
					$this->object->/** @scrutinizer ignore-call */ getCSpSaved(), $this->object->/** @scrutinizer ignore-call */ getCDgSaved() // count total number of drawings saved
				);
			...
			case SpContainer::class:
				...
				if ( $this->object->/** @scrutinizer ignore-call */ getStartCoordinates() ) {
					...
					[
						$column,
						$row,
					] = Coordinate::indexesFromString( $this->object->/** @scrutinizer ignore-call */ getStartCoordinates() );
					$c1 = $column - 1;
					$r1 = $row - 1;
					...
					[
						$column,
						$row,
					] = Coordinate::indexesFromString( $this->object->/** @scrutinizer ignore-call */ getEndCoordinates() );
					$c2 = $column - 1;
					$r2 = $row - 1;
