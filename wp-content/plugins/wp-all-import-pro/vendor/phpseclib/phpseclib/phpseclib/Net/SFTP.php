...
class SFTP extends SSH2 {
	...
	public function chown( $filename, $uid, $recursive = false ) {
       ...
       */
		...
		$attr = $this->version < 4 ? // quoting <http://www.kernel.org/doc/man-pages/online/pages/man2/chown.2.html>,
			// "if the owner or group is specified as -1, then that ID is not changed"
			pack( 'N3', NET_SFTP_ATTR_UIDGID, $uid, - 1 ) : // quoting <https://datatracker.ietf.org/doc/html/draft-ietf-secsh-filexfer-13#section-7.5>,
