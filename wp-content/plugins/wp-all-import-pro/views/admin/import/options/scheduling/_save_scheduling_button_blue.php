...
function renderButton( $buttonText, $isWizard, $continue = false, $saveOnly = false ) {
	?>
	<div
		class="wpai-save-scheduling-button-blue button button-primary button-hero wpallimport-large-button <?php if ( $saveOnly ) { ?> save_only <?php } ?> <?php if ( $continue || $saveOnly ) { ?> wpallimport-button-small-blue <?php } ?>"
