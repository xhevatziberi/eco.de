<div style="padding-top:11px;">
	...
	<div class="run-this-export-using-cronjobs"
	     style="margin-left: 26px; margin-bottom: 10px; font-size: 13px; margin-top:0;"><?php _e( 'Run this import using cron jobs.', 'wp-all-import-pro' ); ?></div>
	<div style="<?php if ( $post['scheduling_enable'] != 2 ) { ?> display: none; <?php } ?>" class="manual-scheduling">
		...
		<p style="margin:0; padding-left: 0;"><?php _e( 'Read more about manual scheduling', 'wp-all-import-pro' ); ?>:
			<a target="_blank" href="https://www.wpallimport.com/documentation/cron/">https://www.wpallimport.com/documentation/cron/</a>
		</p>
	</div>
</div>
