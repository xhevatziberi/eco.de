							...
							<td>
								...
								<div class="wpallimport-unique-key-wrapper" <?php if (!empty(PMXI_Plugin::$session->deligate)):?>style="display:none;"<?php endif; ?>>
									...
									<?php if ( $this->isWizard ):?>
										...
										<p class="new_element_ico"><?php printf(__('On the Data Source screen you selected New Items. So, if you run this import again WP All Import will only try to update records that were created by this import. It will never update, modify, or remove %s that were not created by this import. If you want to match records in this import file to records that already exist on this site, select Existing Items on the Data Source screen.', 'wp-all-import-pro'), $custom_type->labels->name); ?></p>
									<?php endif; ?>
								</div>
