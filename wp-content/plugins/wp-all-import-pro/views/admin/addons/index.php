		...
		<div class="pmxi-add-on-group clear">
			...
			<?php foreach ( $premium as $addon ): ?>
				<div class="pmxi-add-on wp-box <?php if ( $addon['active'] ): ?>pmxi-add-on-active<?php endif; ?>">
					...
					<div class="inner">
						<h3><a target="_blank" href="<?php echo $addon['url']; ?>"><?php echo $addon['title']; ?></a>
						</h3>
					...
					<div class="footer">
						<?php if ( $addon['active'] ): ?>
							<a class="button button-disabled"><span
									class="pmxi-sprite-tick"></span><?php _e( "Installed", 'acf' ); ?></a>
						<?php elseif ( $addon['free_installed'] ): ?>
							<a class="button button-disabled"><span
									class="pmxi-sprite-tick"></span><?php _e( "Free Version Installed", 'acf' ); ?></a>
				...
				<div class="pmxi-add-on wp-box <?php if ( $addon['active'] ): ?>pmxi-add-on-active<?php endif; ?>">
					...
					<div class="footer">
						...
						<?php elseif ( $addon['paid_installed'] ): ?>
							<a class="button button-disabled"><span
									class="pmxi-sprite-tick"></span><?php _e( "Paid Version Installed", 'acf' ); ?></a>
						<?php elseif ( $addon['required_plugins'] ): ?>
							<?php
							$all_required_plugins_installed = true;
							foreach ( $addon['required_plugins'] as $name => $active ):
