...
<form method="post">
	...
	<div class="input">
		<input type="checkbox" id="is_delete_posts" name="is_delete_posts" class="switcher" /> <label
			for="is_delete_posts"><?php _e( 'Delete associated posts as well', 'wp-all-import-pro' ); ?> </label>
