		...
		<?php foreach ( $addons as $class => $addon ) : if ( ! $addon['active'] ) {
			...
			<tr valign="top">
				...
				<td style="vertical-align: middle; width: 360px;">
					<input id="<?php echo $class; ?>_license_key" name="licenses[<?php echo $class; ?>]" type="text"
					       class="regular-text" value="<?php if ( ! empty( $post['licenses'][ $class ] ) ) {
						esc_attr_e( $post['licenses'][ $class ] );
					} ?>" />
				</td>
