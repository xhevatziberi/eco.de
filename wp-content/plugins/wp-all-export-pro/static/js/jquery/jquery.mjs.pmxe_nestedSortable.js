			...
			function _recursiveArray(item, depth, left) {
				...
				if (id) {
					...
					ret.push({
						...
						"right": right,
						"parent_id": pid,
						"element": $(item).find('input.wp_all_export_xml_element').val(),
						"title": $(item).find('input.wp_all_export_xml_element_title').val(),
						"condition": $(item).find('input.wp_all_export_rule').val(),
						"value": $(item).find('input.wp_all_export_value').val(),
						"clause": clause
					});
				}
