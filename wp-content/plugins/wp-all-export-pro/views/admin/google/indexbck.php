...
<div ng-app="GoogleMerchants" ng-controller="mainController" ng-init="init()">
	<div class="wpallexport-header">
		...
		<div class="wpallexport-links">
			<a href="http://www.wpallimport.com/support/" target="_blank">Support</a> | <a
				href="http://www.wpallimport.com/documentation/" target="_blank">Documentation</a>
		</div>
	</div>
	<div class="clear"></div>
					...
					<div class="wpallexport-xml resetable" style="max-height: 865px;">
						...
						<ul>
							...
							<div class="wpae-custom-field">
								<ul>
									...
									<li class="available_sub_section">
										<p class="wpae-available-fields-group">Attributes<span
												...
												<li class="ui-draggable ui-draggable-handle">
													<div class="default_column" rel="">
														...
														<input type="hidden" name="rules[]"
														       value="pmxe_product_data_attributes">
													</div>
												</li>
							...
							<div class="wpae-custom-field">
								<ul>
									<li class="available_sub_section">
										<p class="wpae-available-fields-group">Images<span
												class="wpae-expander">+</span></p>
										<div class="wpae-custom-field">
											<ul>
												<li class="ui-draggable ui-draggable-handle">
												...
												<li class="pmxe_media_images wp_all_export_auto_generate ui-draggable ui-draggable-handle">
													<div class="custom_column" rel="22">
														...
														<input type="hidden" name="cc_options[]"
														       value="{&quot;is_export_featured&quot;:true,&quot;is_export_attached&quot;:true,&quot;image_separator&quot;:&quot;|&quot;}">
									...
									<li class="available_sub_section">
										<p class="wpae-available-fields-group">Attachments<span
												class="wpae-expander">+</span></p>
										<div class="wpae-custom-field">
											<ul>
												<li class="ui-draggable ui-draggable-handle">
								...
								<ul>
									...
									<li class="pmxe_other  ui-draggable ui-draggable-handle">
										<div class="custom_column" rel="90">
											<label class="wpallexport-xml-element">Min Regular Price Variation
												ID</label>
											<input type="hidden" name="ids[]" value="1">
											<input type="hidden" name="cc_label[]"
											       value="_min_regular_price_variation_id">
											<input type="hidden" name="cc_php[]" value="0">
											<input type="hidden" name="cc_code[]" value="">
											<input type="hidden" name="cc_sql[]" value="0">
											<input type="hidden" name="cc_options[]" value="0">
											...
											<input type="hidden" name="cc_name[]"
											       value="Min Regular Price Variation ID">
											<input type="hidden" name="cc_settings[]" value="0">
										</div>
									</li>
									<li class="pmxe_other  ui-draggable ui-draggable-handle">
										<div class="custom_column" rel="91">
											<label class="wpallexport-xml-element">Max Regular Price Variation
												ID</label>
											<input type="hidden" name="ids[]" value="1">
											<input type="hidden" name="cc_label[]"
											       value="_max_regular_price_variation_id">
											<input type="hidden" name="cc_php[]" value="0">
											<input type="hidden" name="cc_code[]" value="">
											<input type="hidden" name="cc_sql[]" value="0">
											<input type="hidden" name="cc_options[]" value="0">
											...
											<input type="hidden" name="cc_value[]"
											       value="_max_regular_price_variation_id">
											<input type="hidden" name="cc_name[]"
											       value="Max Regular Price Variation ID">
											<input type="hidden" name="cc_settings[]" value="0">
										</div>
									</li>
									<li class="pmxe_other  ui-draggable ui-draggable-handle">
