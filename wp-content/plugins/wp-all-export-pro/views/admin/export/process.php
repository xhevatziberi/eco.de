		...
		<div class="processing_step_1">
			...
			<div
				...
				<div class="export_progress">
					<span class="left_progress"><?php esc_html_e( 'Time Elapsed', 'wp_all_export_plugin' ); ?> <span
				...
				foreach ( $exportList->getBy( 'parent_id', $update_previous->id )->convertRecords() as $child_export ) {
					...
					<div
						...
						<div class="export_progress">
							...
							<span
								class="right_progress"><?php esc_html_e( 'Exported', 'wp_all_export_plugin' ); ?> <span
