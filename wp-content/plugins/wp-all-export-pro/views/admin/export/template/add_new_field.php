...
<form>
	<div class="wp-all-export-field-options" style="width: 54%; float:left; max-height: 770px;">
		<div class="input" style="margin-bottom: 15px;">
			<label style="padding:4px; display: block;"
			       class="wpae_column_name"><?php esc_html_e( 'Column name', 'wp_all_export_plugin' ); ?></label>
			<label style="padding:4px; display: none;"
			       class="wpae_element_name"><?php esc_html_e( 'Element name', 'wp_all_export_plugin' ); ?></label>
			<div class="clear"></div>
			<input type="text" class="column_name" value=""
			       style="width:100%; padding: 8px; border-radius: 5px; color: #000;" />
		</div>
		<!-- SINGLE ELEMENT -->
		<div class="input">
			<label>
				<input type="radio" name="combine_multiple_fields" value="0"
				       checked="checked" /> <?php esc_html_e( 'Select a field to export', 'wp_all_export_plugin' ) ?>
			</label>
		</div>
		...
		<div class="input" style="margin-top: 5px;">
			<label><input type="radio" name="combine_multiple_fields"
			              value="1" /> <?php esc_html_e( 'Custom export field', 'wp_all_export_plugin' ) ?></label>
		</div>
		<div class="elements export-multiple" id="combine_multiple_fields_value_container"
		     style="margin-top: 10px; margin-left: 25px; display: none;">
			<textarea
				placeholder="<?php esc_html_e( 'You can drag and drop fields from Available Data, add static text, and use PHP functions', 'wp_all_export_plugin' ); ?>"
				id="combine_multiple_fields_value" style="width: 100%;" rows="7"></textarea>
		</div>
	...
	<div style="width: 35%; float: right; margin-right: 33px; margin-top:10px; display: none;"
	     class="wpae_available_data export-multiple"
	     id="combine_multiple_fields_data">
		<fieldset id="available_data" class="optionsset rad4 wpae_available_data dialog-available-data"
