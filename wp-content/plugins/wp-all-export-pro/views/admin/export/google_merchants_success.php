...
<div class="google-merchants-success">
	<input type="hidden" id="wpae_wp_hidden_field"
	       class="<?php echo esc_attr( wp_create_nonce( '_wpnonce-download_feed' ) ); ?>" />
	<div class="wpae-container">
		<h3>What's next?</h3>

		<ol>
			<li>1. Go to the <a class="merchants-dashboard-url"
			                    href="https://merchants.google.com/mc/feeds/dashboard?scope=products" target="_blank">Google
					Merchants Dashboard</a></li>
	...
	<p class="feed-url">
		<a href="<?php echo esc_url( $urlToExport ); ?>" <?php if ( php_sapi_name() != 'cli-server' ) { ?> target="_blank" <?php } ?>
		   class="feed-url"><?php echo esc_url( $urlToExport ); ?></a>
	</p>
</div>
