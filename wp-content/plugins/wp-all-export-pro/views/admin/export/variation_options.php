...
<div class="product_variations">
	...
	<div class="input" style="display: inline-block; width: 100%;">
		<div>
			...
			<div
				class="sub-options sub-options-<?php echo esc_attr( XmlExportEngine::VARIABLE_PRODUCTS_EXPORT_PARENT_AND_VARIATION ); ?>">
		...
		<div style="margin: 6px 0;">
			...
			<div
				class="sub-options sub-options-<?php echo esc_attr( XmlExportEngine::VARIABLE_PRODUCTS_EXPORT_VARIATION ); ?>">
				<label style="display: block; margin-bottom: 8px;">
					<input type="radio"
						<?php if ( XmlExportEngine::get_addons_service()->isWooCommerceProductAddonActive() ) {
							echo "disabled";
		...
		<?php if ( XmlExportEngine::get_addons_service()->isWooCommerceProductAddonActive() ) { ?>
			<div class="wpallexport-free-edition-notice" style="padding: 20px; margin-bottom: 10px; display: block;">
				...
				<a style="margin: 1em 0;" class="upgrade_link" target="_blank"
				   href="http://www.wpallimport.com/portal/discounts?utm_source=export-plugin-pro&utm_medium=upgrade-notice&utm_campaign=export-variations">
