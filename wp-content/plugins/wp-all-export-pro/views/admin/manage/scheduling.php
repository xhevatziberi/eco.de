...
<p>
	...
	<input style='width: 700px;' type='text'
	       value='<?php echo site_url() . '/wp-load.php?export_key=' . $cron_job_key . '&export_id=' . $id . '&action=trigger'; ?>' />
	<br /><br />
	...
	<input style='width: 700px;' type='text'
	       value='<?php echo site_url() . '/wp-load.php?export_key=' . $cron_job_key . '&export_id=' . $id . '&action=processing'; ?>' /><br /><br />
...
<p>wget -q -O /dev/null
	"<?php echo esc_url( site_url() . '/wp-load.php?export_key=' . $cron_job_key . '&export_id=' . $id . '&action=trigger' ); ?>
	"</p>
...
<p>wget -q -O /dev/null
	"<?php echo esc_url( site_url() . '/wp-load.php?export_key=' . $cron_job_key . '&export_id=' . $id . '&action=processing' ); ?>
	"</p>
