...
class Round {
	...
	public static function up( $number, $digits ) {
		...
		if ( PHP_VERSION_ID >= 80400 ) {
			return round( (float) (string) $number, $digits, RoundingMode::AwayFromZero //* @phpstan-ignore-line
			);
		}
	...
	public static function down( $number, $digits ) {
		...
		if ( PHP_VERSION_ID >= 80400 ) {
			return round( (float) (string) $number, $digits, RoundingMode::TowardsZero //* @phpstan-ignore-line
			);
		}
