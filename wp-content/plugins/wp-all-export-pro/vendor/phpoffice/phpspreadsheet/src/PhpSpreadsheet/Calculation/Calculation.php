...
class Calculation {
	...
	public static function translateSeparator(
		string $fromSeparator, string $toSeparator, string $formula, int &$inBracesLevel, string $openBrace = self::FORMULA_OPEN_FUNCTION_BRACE, string $closeBrace = self::FORMULA_CLOSE_FUNCTION_BRACE
	): string {
	...
	private static function translateFormulaBlock(
		array $from, array $to, string $formula, int &$inFunctionBracesLevel, int &$inMatrixBracesLevel, string $fromSeparator, string $toSeparator
	): string {
		// Function Names
	...
	protected function raiseFormulaError( string $errorMessage, int $code = 0, ?Throwable $exception = null ) {
		...
		$this->cyclicReferenceStack->clear();
		$suppress = /** @scrutinizer ignore-deprecated */
			$this->suppressFormulaErrors ?? $this->suppressFormulaErrorsNew;
		if ( ! $suppress ) {
