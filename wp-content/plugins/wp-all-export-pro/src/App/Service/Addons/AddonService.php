...
class AddonService {
	...
	public function userExportsExistAndAddonNotInstalled() {
		...
		foreach ( $exports as $item ) {
			...
			if ( ( ( in_array( 'users', $item['options']['cpt'] ) || in_array( 'shop_customer', $item['options']['cpt'] ) ) && ! $this->isUserAddonActive() ) || ( $item['options']['export_type'] == 'advanced' && $item['options']['wp_query_selector'] == 'wp_user_query' && ! $this->isUserAddonActive() ) ) {
				return true;
			}
	...
	public function wooCommerceExportsExistAndAddonNotInstalled() {
		...
		foreach ( $exports as $item ) {
			...
			if ( ( ( ( in_array( 'product', $item['options']['cpt'] ) && ! $this->isWooCommerceProductAddonActive() && \class_exists( 'WooCommerce' ) ) || in_array( 'product_variation', $item['options']['cpt'] ) || ( in_array( 'shop_order', $item['options']['cpt'] ) && ! $this->isWooCommerceOrderAddonActive() ) || in_array( 'shop_review', $item['options']['cpt'] ) || in_array( 'shop_coupon', $item['options']['cpt'] ) ) && ! $this->isWooCommerceAddonActive() ) ) {
				return true;
			}
	...
	public function wooCommerceRealTimeExportsExistAndAddonNotInstalled() {
		...
		foreach ( $exports as $item ) {
			...
			if ( ( ( ( in_array( 'product', $item['options']['cpt'] ) && ! $this->isWooCommerceProductAddonActive() && \class_exists( 'WooCommerce' ) ) || in_array( 'product_variation', $item['options']['cpt'] ) || ( in_array( 'shop_order', $item['options']['cpt'] ) && ! $this->isWooCommerceOrderAddonActive() ) || in_array( 'shop_review', $item['options']['cpt'] ) || in_array( 'shop_coupon', $item['options']['cpt'] ) ) && ! $this->isWooCommerceAddonActive() && isset( $item['options']['enable_real_time_exports'] ) && $item['options']['enable_real_time_exports'] ) ) {
				return true;
			}
	...
	public function userRealTimeExportsExistAndAddonNotInstalled() {
		...
		foreach ( $exports as $item ) {
			...
			if ( ( ( in_array( 'users', $item['options']['cpt'] ) || in_array( 'shop_customer', $item['options']['cpt'] ) ) && ! $this->isUserAddonActive() ) || ( $item['options']['export_type'] == 'advanced' && $item['options']['wp_query_selector'] == 'wp_user_query' && ! $this->isUserAddonActive() && isset( $item['options']['enable_real_time_exports'] ) && $item['options']['enable_real_time_exports'] ) ) {
				return true;
			}
