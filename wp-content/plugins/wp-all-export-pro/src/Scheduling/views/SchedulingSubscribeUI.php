...
<div class="subscribe" id="scheduling-subscribe-group" style="margin-left: 5px; position: relative;">
	<div class="tiered-pricing-options">
		<h3 class="subscribe-heading">Reliable, simple, and powerful. Get started with Automatic Scheduling right
			now.</h3>
		<span class="">
		...
		<span class="button-and-text-container" id="scheduling-button-and-text-container">
                                        <span class="register-site-group hidden" id="register-site-group">
                                            <span class="activate-button-group">
                                                ...
                                                <span class="loader"
                                                      style="position: absolute;left: 55px;bottom: 58px;display:none;"></span>
                                            </span>
                                        ...
                                        <span class="subscribe-button-group" id="subscribe-button-group">
                                            <button type="button" class="subscribe"
                                                    id="subscribe"><span>Subscribe Now</span></button>
