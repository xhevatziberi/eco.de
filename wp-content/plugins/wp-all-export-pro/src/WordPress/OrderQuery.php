...
class OrderQuery {
	...
	protected function is_export_new_stuff() {
		...
		return ( ! empty( \XmlExportEngine::$exportOptions['export_only_new_stuff'] ) && $export_id );
	}
	...
	protected function is_export_modfified_stuff() {
		...
		return ( ! empty( \XmlExportEngine::$exportOptions['export_only_modified_stuff'] ) && $export_id );
	}
