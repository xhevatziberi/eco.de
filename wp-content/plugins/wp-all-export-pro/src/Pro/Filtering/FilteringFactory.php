...
class FilteringFactory {
	...
	public static function render_filtering_block( $engine, $isWizard, $post, $is_on_template_screen = false ) {
		...
		if ( $isWizard or $post['export_type'] != 'specific' ) {
			return;
		}
		...
		<div class="wpallexport-collapsed wpallexport-section closed">
			<div id="wpallexport-filtering-container" class="wpallexport-content-section wpallexport-filtering-section"
			     <?php if ( $is_on_template_screen ): ?>style="margin-bottom: 10px;"<?php endif; ?>>
