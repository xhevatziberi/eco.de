...
function pmxe_render_xml_element( $el, $shorten = false, $path = '/', $ind = 1, $lvl = 0 ) {
	...
	if ( $el->hasChildNodes() ) {
		...
		echo '<div class="xml-tag opening">&lt;<span class="xml-tag-name">' . esc_html( $el->nodeName ) . '</span>';
		...
		echo '<div class="xml-tag opening empty">&lt;<span class="xml-tag-name">' . esc_html( $el->nodeName ) . '</span>';
