	...
	function wp_all_export_generate_link( $text, $href ) {
		...
		<span class="wp-all-export-link-wrapper">
				<a class="wp-all-export-link" href="<?php echo esc_url( $href ); ?>" target="_blank">
					...
					<svg class="wp-all-export-link-arrow" width="13" height="11" viewBox="0 0 13 11" fill="none"
					     xmlns="http://www.w3.org/2000/svg">
						<title>Arrow</title>
						<path d="M8 1.5L12 5.5L8 9.5" stroke="currentColor" stroke-width="2" stroke-linecap="round"
