...
class PMXE_Addon_Field {
	...
	public function __construct(
		array $data, PMXE_Addon_Resolver $resolver, $settings, $elName, $elNameNs = null, $phpFunction = null, // Subfields
		?PMXE_Addon_Field $parent = null, $repeater_row_index = null
	) {
		$this->data        = $data;
	...
	public function toString() {
		if ( $this->multiple ) {
			return is_array( $this->value ) ? implode( $this->getImplode(), $this->value ) : $this->value;
		}
	...
	public function getInvertedDelimiter() {
		return apply_filters( 'wp_all_export_repeater_delimiter', \XmlExportEngine::$exportOptions['delimiter'] == ',' ? '|' : ',', \XmlExportEngine::$exportID );
	}
	...
	public static function from(
		$field, PMXE_Addon_Resolver $resolver, $settings, $elName, $elNameNs = null, $phpFunction = null, // Subfields
		PMXE_Addon_Field $parent = null, $repeater_row_index = null, $resolve = true
	) {
		...
		return new $class( $field, $resolver, $settings, $elName, $elNameNs, $phpFunction, $parent, $repeater_row_index, );
	}
}
