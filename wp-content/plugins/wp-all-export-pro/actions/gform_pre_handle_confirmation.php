...
function pmxe_gform_pre_handle_confirmation( $lead, $form ) {
	...
	foreach ( $exportList as $export ) {
		if ( isset( $export['options']['enable_real_time_exports'] ) && $export['options']['enable_real_time_exports'] && isset( $export['options']['enable_real_time_exports_running'] ) && $export['options']['enable_real_time_exports_running'] && $export['options']['sub_post_type_to_export'] == $form_id ) {
