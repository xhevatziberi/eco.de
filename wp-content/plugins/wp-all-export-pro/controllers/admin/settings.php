					...
					if ( ( $extension != "txt" ) ) {
						...
						if ( ! empty( $import_data ) ) {
							...
							if ( ! empty( $templates_data ) ) {
								...
								$this->errors->add( 'form-validation', esc_html__( 'Wrong imported data format', 'wp_all_export_plugin' ) );
							}
						} else {
							$this->errors->add( 'form-validation', esc_html__( 'File is empty or doesn\'t exests', 'wp_all_export_plugin' ) );
						}
					}
				} else {
					$this->errors->add( 'form-validation', esc_html__( 'Undefined entry!', 'wp_all_export_plugin' ) );
				}
			} else {
				$this->errors->add( 'form-validation', esc_html__( 'Please select file.', 'wp_all_export_plugin' ) );
			}
